                ...
                <div className="flex gap-5 items-center w-2/3 justify-end md:flex-col ">
                    <div>
                        <ul className="flex md:flex-col gap-2 font-semibold">
                            <li className="hover:bg-white dark:hover:bg-theme_gray-dark rounded-lg px-4 py-2">
                            ...
                            <li className="hover:bg-white dark:hover:bg-theme_gray-dark rounded-lg px-4 py-2 whitespace-nowrap">
